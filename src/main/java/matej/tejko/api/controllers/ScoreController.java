...
import matej.tejko.api.services.ScoreService;
import matej.tejko.interfaces.api.controllers.ScoreControllerInterface;
...
public class ScoreController implements ScoreControllerInterface {
	...
	@PatchMapping("/{id}}")
	@Override
	public ResponseEntity<Score> updateById(@PathVariable UUID id, @RequestBody JsonPatch objectRequest)
	...
	@PatchMapping("/bulk")
	@Override
	public ResponseEntity<List<Score>> updateBulkById(@RequestBody Map<UUID, JsonPatch> idObjectRequestMap)
			throws JsonProcessingException, JsonPatchException {
