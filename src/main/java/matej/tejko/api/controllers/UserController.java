...
import matej.tejko.interfaces.api.controllers.UserControllerInterface;
...
public class UserController implements UserControllerInterface {
	...
	@PatchMapping("/{id}")
	@Override
	public ResponseEntity<User> updateById(@PathVariable UUID id, @RequestBody JsonPatch objectRequest)
	...
	@PatchMapping("/bulk")
	@Override
	public ResponseEntity<List<User>> updateBulkById(@RequestBody Map<UUID, JsonPatch> idObjectRequestMap)
			throws JsonProcessingException, JsonPatchException {
