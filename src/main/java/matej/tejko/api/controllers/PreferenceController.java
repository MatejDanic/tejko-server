...
import matej.tejko.api.services.PreferenceService;
import matej.tejko.interfaces.api.controllers.PreferenceControllerInterface;
...
public class PreferenceController implements PreferenceControllerInterface {
    ...
    @PatchMapping("/{id}")
    @Override
    public ResponseEntity<Preference> updateById(UUID id, JsonPatch objectRequest)
    ...
    @PatchMapping("/bulk")
    @Override
    public ResponseEntity<List<Preference>> updateBulkById(Map<UUID, JsonPatch> idObjectRequestMap)
            throws JsonProcessingException, JsonPatchException {
