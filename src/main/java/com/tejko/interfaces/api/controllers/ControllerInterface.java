...
public interface ControllerInterface<I, T, R> {
        ...
        @PatchMapping("/{id}")
        public ResponseEntity<T> updateById(@PathVariable I id, @RequestBody JsonPatch objectPatch)
                        throws JsonProcessingException, JsonPatchException;

        @PatchMapping("/bulk")
        public ResponseEntity<List<T>> updateBulkById(@RequestBody Map<I, JsonPatch> idObjectPatchMap)
                        throws JsonProcessingException, JsonPatchException;
